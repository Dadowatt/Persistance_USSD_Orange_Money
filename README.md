...
Ce projet simule un service USSD simplifié d'Orange Money, permettant aux utilisateurs d'effectuer des opérations financières de base via un menu en ligne de commande. Les fonctionnalités incluent l'achat de forfaits internet, l'envoi d'argent par transfert, l'annulation du dernier transfert et l'affichage de l'historique des transactions.
